...
Unit tests are in the `__tests__` folder, and end-to-end tests are in the `workflows` folder (in particular, in the file [test-dotnet.yml](https://github.com/actions/setup-dotnet/blob/main/.github/workflows/test-dotnet.yml).
